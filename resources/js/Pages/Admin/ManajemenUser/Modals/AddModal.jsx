                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Buat akun untuk akses sistem SIRA.
                            </p>
                        </div>
                    </div>
                    <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className="md:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full border-gray-300 rounded-xl shadow-sm py-2.5 px-4 border focus:ring-2 focus:ring-indigo-500 text-sm bg-white"
                                />
                            </div>
